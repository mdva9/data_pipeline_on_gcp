...
with DAG(
    ...
    download_taxi_data = BashOperator(
        ...
        bash_command="""
                    gsutil cp gs://aerobic-smithy-473613-q9-data-bucket/from-git/download_taxi_data.py /tmp/download_taxi_data.py &&
    ...
    load_raw_trips_data = BashOperator(
        ...
        bash_command="""
                    gsutil cp gs://aerobic-smithy-473613-q9-data-bucket/from-git/load_raw_trips_data.py /tmp/load_raw_trips_data.py &&
    ...
    transform_trips_data = BashOperator(
        ...
        bash_command="""
                    gsutil cp gs://aerobic-smithy-473613-q9-data-bucket/from-git/transform_trips_data.py /tmp/transform_trips_data.py &&
